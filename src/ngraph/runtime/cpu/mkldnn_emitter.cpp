                                        ...
                                        const mkldnn::memory::desc& dst_iter_desc)
{
    ...
    auto rnn_workspace_memory = mkldnn::memory(rnn_layer_prim_desc.workspace_primitive_desc());
    ...
    std::cout << "rnn worskpace " << rnn_layer_prim_desc.workspace_primitive_desc().get_size()
              << std::endl;
    std::cout << "rnn worskpace index " << (*m_mkldnn_primitives[workspace_index]).get()
              << std::endl;
