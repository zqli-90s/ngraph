...
namespace ngraph
{
    namespace onnxifi
    {
        ...
        public:
            ...
            virtual std::shared_ptr<runtime::TensorView> to_ng(runtime::Backend& backend) const = 0;
        ...
        public:
            using Tensor::Tensor;
            std::shared_ptr<runtime::TensorView> to_ng(runtime::Backend& backend) const final;
        };
        ...
        public:
            using Tensor::Tensor;
            std::shared_ptr<runtime::TensorView> to_ng(runtime::Backend& backend) const final;
            void from_ng(const runtime::TensorView& tensor);
        };
    }
}
