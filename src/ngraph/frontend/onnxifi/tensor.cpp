...
namespace ngraph
{
    namespace onnxifi
    {
        std::shared_ptr<runtime::TensorView> InputTensor::to_ng(runtime::Backend& backend) const
        {
        ...
        std::shared_ptr<runtime::TensorView> OutputTensor::to_ng(runtime::Backend& backend) const
        {
            switch (m_tensor.dataType)
            {
            case ONNXIFI_DATATYPE_FLOAT16:
        ...
        void OutputTensor::from_ng(const runtime::TensorView& tensor)
        {
