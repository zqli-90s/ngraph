...
namespace ngraph
{
    namespace onnxifi
    {
        ...
        public:
            ...
            const std::vector<std::shared_ptr<runtime::TensorView>>& get_inputs() const
            {
                return m_inputs;
            }

            const std::vector<std::shared_ptr<runtime::TensorView>>& get_outputs() const
            {
                return m_outputs;
            }
        ...
        private:
            ...
            std::vector<std::shared_ptr<runtime::TensorView>> m_inputs{}, m_outputs{};
        };
