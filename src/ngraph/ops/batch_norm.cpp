                                              ...
                                              const std::shared_ptr<Node>& delta)
{
    ...
    //std::cout << "  get_outputs().at(1).get_inputs() " <<  get_outputs().at(1).get_inputs() << std::endl
    // auto& mean = get_outputs().at(1);
    // auto mean1 = (*mean.get_inputs().begin())->get_node();
    // auto& variance = get_outputs().at(2);
    // auto var1 = (*variance.get_inputs().begin())->get_node();
