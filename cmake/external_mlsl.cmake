...
install(DIRECTORY ${INSTALL_DIR}/intel64/bin/
        DESTINATION ${NGRAPH_INSTALL_BIN})
install(CODE "execute_process(COMMAND sed -i -e \"s|intel64/||g\" ${NGRAPH_INSTALL_BIN}/mlslvars.sh)")
install(CODE "execute_process(COMMAND sed -i -e \"s|export MLSL_ROOT=.*|export MLSL_ROOT=${CMAKE_INSTALL_PREFIX}|g\" ${NGRAPH_INSTALL_BIN}/mlslvars.sh)")
